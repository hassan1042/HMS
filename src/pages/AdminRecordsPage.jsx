...
import { fetchHalls, fetchHallsBookings } from "../services/hallRegService";
...
const AdminRecordsPage = () => {
  ...
  const {currentUser} = useAuth();
   ...
   const bookingFields = {
    ...
    "Wedding Hall Bookings": ["name", "hallName", "startDate", "endDate", "status"],
  ...
  const fetchBookings = async () => {
    ...
    if (activeTab === "Wedding Hall Bookings") data = await fetchHallsBookings();
  ...
  return (
    <div className="p-4">
      ...
      <div>
        ...
        <>
      {
        activeTab === "Food Order" &&  <FoodOrder
          activeTab={activeTab}
      ...
      {
          activeTab === "Rental Bookings" &&  <VehicleOrder
          activeTab={activeTab}
          bookingFields={bookingFields}
          bookings={bookings}
         />
      ...
      {
          activeTab === "Wedding Hall Bookings" &&  <Halls
          activeTab={activeTab}
          bookingFields={bookingFields}
          bookings={bookings}
         />
